...
export default function Home() {
  ...
  return (
    ...
    :
     <Box  mt={[0,0,0,5]}  width={["100%","100%","100%","95%","95%",1200]} mr="auto" ml="auto"  p={[3,0,0]} display="flex" flexDirection={["column","column","column","column","row"]} minH={["300px","300px","400px","500px","600px"]}>
         {data && <Cart />}
     </Box>}
