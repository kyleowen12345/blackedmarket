...
const BannerLink = () => {
    return (
        <Box display={"flex"} justifyContent="space-between"    mb={20} bg="white" width={["100%","100%","100%","100%","100%",1200]} boxShadow="md" position="sticky" top={0} border="2px solid #FC8E00">
            <Link href="#products" _hover={{textDecoration:"none"}} width="33vw">
                <Box  p={3} pl={[0,1,3,5]}  display="flex" alignItems="center" >
                     ...
                     <Text fontSize={["11px","12px","15px","17px"]} fontWeight="bold" color="#FC8E00" ml={[0,1,2,3]} isTruncated>
                        New Products
                     </Text>
            ...
            <Link href="#Deals" _hover={{textDecoration:"none"}}  width="33vw">
              <Box p={3} pl={[0,1,3,5]}  pr={[0,1,3,5]} display="flex" alignItems="center">
                  ...
                  <Text fontSize={["11px","12px","15px","17px"]}  fontWeight="bold" color="#FC8E00" ml={[0,1,2,3]}>
                    Best Seller
                  </Text>
                  <ChevronDownIcon ml="auto" color="#FC8E00" />
              </Box>
