...
const SmallMenu = () => {
    ...
    return (
        <Box display={["flex","flex","flex","flex","none"]} bg="white" justifyContent="space-around" position="sticky" top={0}  p={2} mb={2} boxShadow="md" zIndex={99999}  width="100%" height="40px" borderBottom="2px solid #FC8E00">
