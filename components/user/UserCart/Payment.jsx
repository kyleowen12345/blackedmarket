...
const Payment = () => {
    ...
    return (
        <Box p={5} bg="white" width="100%" display="flex" justifyContent="space-between" alignItems="center" boxShadow="md" borderRadius={5} position="sticky" bottom={0}>
            <Box>
               <Text fontWeight="bold" fontSize="13px">@ BlackedMarket is the sh**t son.....</Text> 
            </Box>
