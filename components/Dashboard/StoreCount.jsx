...
const StoreCount = ({data}) => {
    return (
        <Box width={["100%","100%","100%","30%"]} bg="white"  borderRadius={5} boxShadow="md" mr={5} textAlign="center" p={5} >
        <Text fontWeight="bold" height="10%">Total store count</Text>
        <Text fontWeight="bold" fontSize="150px" height="80%">{data?.storeCount}</Text>
