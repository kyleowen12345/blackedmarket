    ...
    return (
        <Grid templateColumns={ "repeat(2, auto)"} gridColumnGap={10}  display={["none","none","grid"]} ml="50px" height="150px" mt="auto" pt={5}>
            ...
            <Box display="flex" alignItems="center" height="30px">
               ...
               <Text fontSize={["11px","11px","11px","13px"]}>Store:</Text>
               <Text fontSize={["8px","10px","11px","13px"]} fontWeight="bold" ml={3} color="#FC8E00">{store.storeName}</Text>
            </Box>
            <Box display="flex" alignItems="center" height="30px">
               <Icon as={AiOutlineUser}  mr={3}/>
               <Text fontSize={["11px","11px","11px","13px"]}>Owner:</Text>
               <Text fontSize={["8px","10px","11px","13px"]} fontWeight="bold" ml={3} color="#FC8E00">{store.sellerName.name}</Text>
            </Box>
            <Box display="flex" alignItems="center" height="30px">
               <Icon as={AiOutlineMail}  mr={3}/>
               <Text fontSize={["11px","11px","11px","13px"]}>Email:</Text>
               <Text fontSize={["8px","10px","11px","13px"]} fontWeight="bold" ml={3} color="#FC8E00">{store.sellerName.email}</Text>
            </Box>
            <Box display="flex" alignItems="center" height="30px">
               <Icon as={AiOutlineAppstoreAdd}  mr={3}/>
               <Text fontSize={["11px","11px","11px","13px"]}>Store Type:</Text>
               <Text fontSize={["8px","10px","11px","13px"]} fontWeight="bold" ml={3} color="#FC8E00">{store.storeType}</Text>
            </Box>
            <Box display="flex" alignItems="center" height="30px">
