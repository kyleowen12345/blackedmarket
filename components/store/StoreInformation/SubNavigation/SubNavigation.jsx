...
const SubNavigation = ({storeId}) => {
    ...
    return (
        <Box bg="white" borderTop="1px solid rgb(234,234,234)" display="flex" justifyContent="space-between"  alignItems="center"  pt={[2,2,2,2,4]} height={["40px","40px","40px","50px"]} boxShadow="md" mb={10} borderBottom="2px solid #FC8E00">
