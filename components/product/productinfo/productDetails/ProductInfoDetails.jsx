           ...
           {product?.product.storeOwner.id === userData?.id && <Box m={3} display={"flex"} mt={5}>
            ...
            <Box display={"flex"} width={["290px","290px","310px","400px"]} justifyContent="space-between" m={3} mt={[5,5,7]}>
                <Link href={`/products/updateproduct/${product.product.id}`} passHref>
                    <Button fontSize={["13px","13px","18px"]} width={["120px","120px","150px","180px"]} bg="#EAEDED" color="gray" border="1px solid gray" as="a"><Icon as={AiOutlineEdit} color="gray" mr={2}/>Update</Button>
                </Link>
