        ...
        <Box p={5} pt={[0,0,5]} pb={[0,0,5]}>
                <Box display="flex" alignItems="center" >
                    <Box>
                      ...
                      <Text fontSize={["15px","15px","15px","25px"]} fontWeight="bold" ml={[5,5,10]} maxW={["200px","200px","210px","300px","400px"]} isTruncated>{product?.productName}</Text>
                </Box>
                <Box d="flex" mt="2"  alignItems="center" width={["200px","200px","200px","500px"]}>
                                   {Array(5)
                                     .fill("")
                                     .map((_,i) => (
                                     <StarIcon
