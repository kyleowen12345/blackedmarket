        ...
        <Box ml={["auto","auto",0,0,10]} width={["300px","300px","60%","800px"]}  mr="auto">
          ...
          <Shipping product={product.product}/>
           ...
           {product?.product.storeOwner.id === userData?.id && <Box m={3} display={"flex"} mt={5}>
            ...
            <Box display={"flex"} width={["290px","290px","290px","400px"]} justifyContent="space-between" m={3} mt={[5,5,7]}>
                <Link href={`/products/updateproduct/${product.product.id}`} passHref>
                    <Button fontSize={["13px","13px","18px"]} width={["120px","120px","140px","180px"]} bg="#EAEDED" color="gray" border="1px solid gray" as="a"><Icon as={AiOutlineEdit} color="gray" mr={2}/>Update</Button>
                </Link>
