...
const SearchInput = () => {
    ...
    return (
         ...
         <Input bg="#ffffff" placeholder="Search for a product here." border="none"  focusBorderColor="none" height="2em" autoComplete="off" py={2} {...register('search', {required: 'this is required',})} mt={1}/>
