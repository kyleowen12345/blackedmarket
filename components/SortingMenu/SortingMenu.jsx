...
const SortingMenu = ({sorterList,sortOrder,route}) => {
    return (
        <Box bg="white"  mt={[0,0,1,1,5]} mb={[2,2,2,2,5]} p={3} pl={[1,1,1,3]} pr={[1,1,1,3]} display="flex" alignItems="center" width="100%" position="sticky" top={0} borderBottom="2px solid #FC8E00">
